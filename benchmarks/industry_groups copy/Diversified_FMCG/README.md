# Diversified FMCG Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Diversified FMCG** industry group, rebalanced quarterly using point-in-time constituent membership.
...
| Metric | Value |
|--------|-------|
| **Total Periods** | 3 quarters |
| **Date Range** | 2025-03-31 to 2025-09-30 |
| **Total Return** | 14.85% |
| **Annualized Return** | 20.28% |
| **Volatility (Std Dev)** | 6.19% |
| **Sharpe Ratio** | 0.79 |
| **Max Drawdown** | -0.24% |
| **Win Rate** | 66.7% |
...
- **5 stocks** (on average)
- Range: 5 to 5 stocks per quarter
...
1. Identify all stocks classified in **Diversified FMCG** industry group
...
plt.title('Diversified FMCG Industry Group Index')
