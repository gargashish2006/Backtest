# Industrial Products Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Industrial Products** industry group, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 1359.39% |
| **Annualized Return** | 32.60% |
| **Volatility (Std Dev)** | 16.33% |
| **Sharpe Ratio** | 0.52 |
| **Max Drawdown** | -56.75% |
| **Win Rate** | 68.4% |
| **Avg Constituents** | 263 stocks |
| **Avg Industries** | 12 industries |
...
- **12 distinct industries** (on average)
- **263 stocks** (on average)
- Range: 206 to 360 stocks per quarter
...
1. Identify all stocks classified in **Industrial Products** industry group
...
plt.title('Industrial Products Industry Group Index')
