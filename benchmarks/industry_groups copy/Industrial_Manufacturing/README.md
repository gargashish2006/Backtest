# Industrial Manufacturing Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Industrial Manufacturing** industry group, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 1334.69% |
| **Annualized Return** | 32.36% |
| **Volatility (Std Dev)** | 17.04% |
| **Sharpe Ratio** | 0.51 |
| **Max Drawdown** | -59.56% |
| **Win Rate** | 71.1% |
| **Avg Constituents** | 105 stocks |
...
- **105 stocks** (on average)
- Range: 77 to 150 stocks per quarter
...
1. Identify all stocks classified in **Industrial Manufacturing** industry group
...
plt.title('Industrial Manufacturing Industry Group Index')
