# Personal Products Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Personal Products** industry group, rebalanced quarterly using point-in-time constituent membership.
...
- Range: 10 to 15 stocks per quarter
...
1. Identify all stocks classified in **Personal Products** industry group
...
plt.title('Personal Products Industry Group Index')
