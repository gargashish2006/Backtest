# Consumer Durables Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Consumer Durables** industry group, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 706.68% |
| **Annualized Return** | 24.58% |
| **Volatility (Std Dev)** | 15.14% |
| **Sharpe Ratio** | 0.45 |
| **Max Drawdown** | -54.22% |
| **Win Rate** | 65.8% |
| **Avg Constituents** | 154 stocks |
| **Avg Industries** | 17 industries |
...
- **17 distinct industries** (on average)
- **154 stocks** (on average)
- Range: 110 to 214 stocks per quarter
...
1. Identify all stocks classified in **Consumer Durables** industry group
...
plt.title('Consumer Durables Industry Group Index')
