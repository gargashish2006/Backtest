# IT - Services Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **IT - Services** industry group, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 1209.82% |
| **Annualized Return** | 31.10% |
| **Volatility (Std Dev)** | 21.30% |
| **Sharpe Ratio** | 0.42 |
| **Max Drawdown** | -57.81% |
| **Win Rate** | 68.4% |
| **Avg Constituents** | 49 stocks |
...
- **49 stocks** (on average)
- Range: 38 to 75 stocks per quarter
...
1. Identify all stocks classified in **IT - Services** industry group
...
plt.title('IT - Services Industry Group Index')
