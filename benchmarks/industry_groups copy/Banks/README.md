# Banks Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Banks** industry group, rebalanced quarterly using point-in-time constituent membership.
...
- Range: 28 to 41 stocks per quarter
...
1. Identify all stocks classified in **Banks** industry group
...
plt.title('Banks Industry Group Index')
