...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Oil** industry group, rebalanced quarterly using point-in-time constituent membership.
...
- Range: 11 to 18 stocks per quarter
...
1. Identify all stocks classified in **Oil** industry group
...
plt.title('Oil Industry Group Index')
