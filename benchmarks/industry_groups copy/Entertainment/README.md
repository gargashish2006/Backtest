# Entertainment Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Entertainment** industry group, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 448.45% |
| **Annualized Return** | 19.62% |
| **Volatility (Std Dev)** | 16.36% |
| **Sharpe Ratio** | 0.36 |
| **Max Drawdown** | -62.97% |
| **Win Rate** | 65.8% |
| **Avg Constituents** | 53 stocks |
...
- **53 stocks** (on average)
- Range: 41 to 63 stocks per quarter
...
1. Identify all stocks classified in **Entertainment** industry group
...
plt.title('Entertainment Industry Group Index')
