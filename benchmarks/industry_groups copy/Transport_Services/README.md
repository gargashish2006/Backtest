# Transport Services Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Transport Services** industry group, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 484.10% |
| **Annualized Return** | 20.42% |
| **Volatility (Std Dev)** | 18.43% |
| **Sharpe Ratio** | 0.34 |
| **Max Drawdown** | -60.17% |
| **Win Rate** | 60.5% |
| **Avg Constituents** | 46 stocks |
...
- **46 stocks** (on average)
- Range: 30 to 70 stocks per quarter
...
1. Identify all stocks classified in **Transport Services** industry group
...
plt.title('Transport Services Industry Group Index')
