# Microfinance Institutions Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Microfinance Institutions** industry, rebalanced quarterly using point-in-time constituent membership.
...
| Metric | Value |
|--------|-------|
| **Total Periods** | 24 quarters |
| **Date Range** | 2019-12-31 to 2025-09-30 |
| **Total Return** | -19.82% |
| **Annualized Return** | -3.62% |
| **Volatility (Std Dev)** | 22.17% |
| **Sharpe Ratio** | 0.08 |
| **Max Drawdown** | -62.48% |
| **Win Rate** | 50.0% |
...
1. Identify all stocks classified in **Microfinance Institutions**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Microfinance Institutions Industry Index')
```
