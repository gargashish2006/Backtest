...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Iron & Steel** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 1962.51% |
| **Annualized Return** | 37.52% |
| **Volatility (Std Dev)** | 24.43% |
| **Sharpe Ratio** | 0.45 |
| **Max Drawdown** | -59.01% |
| **Win Rate** | 68.4% |
...
1. Identify all stocks classified in **Iron & Steel**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Iron & Steel Industry Index')
```
