# Pharmaceuticals Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Pharmaceuticals** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Volatility (Std Dev)** | 15.00% |
| **Sharpe Ratio** | 0.48 |
| **Max Drawdown** | -32.66% |
| **Win Rate** | 60.5% |
| **Avg Constituents** | 144 stocks |
...
1. Identify all stocks classified in **Pharmaceuticals**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Pharmaceuticals Industry Index')
```
