...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Education** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 386.75% |
| **Annualized Return** | 18.13% |
| **Volatility (Std Dev)** | 21.96% |
| **Sharpe Ratio** | 0.29 |
| **Max Drawdown** | -70.64% |
| **Win Rate** | 52.6% |
| **Avg Constituents** | 15 stocks |
...
1. Identify all stocks classified in **Education**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Education Industry Index')
```
