# Distributors Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Distributors** industry, rebalanced quarterly using point-in-time constituent membership.
...
| Metric | Value |
|--------|-------|
| **Total Periods** | 35 quarters |
| **Date Range** | 2017-03-31 to 2025-09-30 |
| **Total Return** | 1258.44% |
| **Annualized Return** | 34.74% |
| **Volatility (Std Dev)** | 23.60% |
| **Sharpe Ratio** | 0.42 |
| **Max Drawdown** | -28.81% |
| **Win Rate** | 60.0% |
...
1. Identify all stocks classified in **Distributors**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Distributors Industry Index')
```
