# LPG/CNG/PNG/LNG Supplier Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **LPG/CNG/PNG/LNG Supplier** industry, rebalanced quarterly using point-in-time constituent membership.
...
1. Identify all stocks classified in **LPG/CNG/PNG/LNG Supplier**
...
# Plot
benchmark.plot(x='date', y='index_value', title='LPG/CNG/PNG/LNG Supplier Industry Index')
```
