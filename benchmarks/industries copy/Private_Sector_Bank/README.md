# Private Sector Bank Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Private Sector Bank** industry, rebalanced quarterly using point-in-time constituent membership.
...
1. Identify all stocks classified in **Private Sector Bank**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Private Sector Bank Industry Index')
```
