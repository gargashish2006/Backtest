# Breweries & Distilleries Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Breweries & Distilleries** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 2312.31% |
| **Annualized Return** | 39.80% |
| **Volatility (Std Dev)** | 22.86% |
| **Sharpe Ratio** | 0.47 |
| **Max Drawdown** | -51.60% |
| **Win Rate** | 63.2% |
...
1. Identify all stocks classified in **Breweries & Distilleries**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Breweries & Distilleries Industry Index')
```
