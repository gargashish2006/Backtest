# Cables - Electricals Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Cables - Electricals** industry, rebalanced quarterly using point-in-time constituent membership.
...
1. Identify all stocks classified in **Cables - Electricals**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Cables - Electricals Industry Index')
```
