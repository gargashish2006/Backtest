# Hotels & Resorts Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Hotels & Resorts** industry, rebalanced quarterly using point-in-time constituent membership.
...
1. Identify all stocks classified in **Hotels & Resorts**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Hotels & Resorts Industry Index')
```
