...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Other Bank** industry, rebalanced quarterly using point-in-time constituent membership.
...
1. Identify all stocks classified in **Other Bank**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Other Bank Industry Index')
```
