# Telecom - Cellular & Fixed line services Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Telecom - Cellular & Fixed line services** industry, rebalanced quarterly using point-in-time constituent membership.
...
1. Identify all stocks classified in **Telecom - Cellular & Fixed line services**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Telecom - Cellular & Fixed line services Industry Index')
```
