# Industrial Gases Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Industrial Gases** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 6119.73% |
| **Annualized Return** | 54.46% |
| **Volatility (Std Dev)** | 22.61% |
| **Sharpe Ratio** | 0.61 |
| **Max Drawdown** | -33.54% |
| **Win Rate** | 68.4% |
...
1. Identify all stocks classified in **Industrial Gases**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Industrial Gases Industry Index')
```
