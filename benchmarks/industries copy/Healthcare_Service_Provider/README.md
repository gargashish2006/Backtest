# Healthcare Service Provider Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Healthcare Service Provider** industry, rebalanced quarterly using point-in-time constituent membership.
...
1. Identify all stocks classified in **Healthcare Service Provider**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Healthcare Service Provider Industry Index')
```
