# Telecom - Infrastructure Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Telecom - Infrastructure** industry, rebalanced quarterly using point-in-time constituent membership.
...
1. Identify all stocks classified in **Telecom - Infrastructure**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Telecom - Infrastructure Industry Index')
```
