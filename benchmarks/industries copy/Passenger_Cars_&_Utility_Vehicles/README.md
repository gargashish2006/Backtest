# Passenger Cars & Utility Vehicles Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Passenger Cars & Utility Vehicles** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 2971.61% |
| **Annualized Return** | 43.41% |
| **Volatility (Std Dev)** | 20.63% |
| **Sharpe Ratio** | 0.55 |
| **Max Drawdown** | -61.36% |
| **Win Rate** | 68.4% |
...
1. Identify all stocks classified in **Passenger Cars & Utility Vehicles**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Passenger Cars & Utility Vehicles Industry Index')
```
