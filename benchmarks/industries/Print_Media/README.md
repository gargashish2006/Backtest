# Print Media Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Print Media** industry, rebalanced quarterly using point-in-time constituent membership.
...
1. Identify all stocks classified in **Print Media**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Print Media Industry Index')
```
