# Port & Port services Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Port & Port services** industry, rebalanced quarterly using point-in-time constituent membership.
...
1. Identify all stocks classified in **Port & Port services**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Port & Port services Industry Index')
```
