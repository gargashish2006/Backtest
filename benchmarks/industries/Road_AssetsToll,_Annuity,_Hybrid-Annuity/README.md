# Road AssetsToll, Annuity, Hybrid-Annuity Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Road AssetsToll, Annuity, Hybrid-Annuity** industry, rebalanced quarterly using point-in-time constituent membership.
...
1. Identify all stocks classified in **Road AssetsToll, Annuity, Hybrid-Annuity**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Road AssetsToll, Annuity, Hybrid-Annuity Industry Index')
```
