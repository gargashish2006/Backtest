# Consulting Services Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Consulting Services** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 1291.34% |
| **Annualized Return** | 31.94% |
| **Volatility (Std Dev)** | 26.20% |
| **Sharpe Ratio** | 0.37 |
| **Max Drawdown** | -41.08% |
| **Win Rate** | 55.3% |
...
1. Identify all stocks classified in **Consulting Services**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Consulting Services Industry Index')
```
