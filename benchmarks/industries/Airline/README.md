...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Airline** industry, rebalanced quarterly using point-in-time constituent membership.
...
1. Identify all stocks classified in **Airline**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Airline Industry Index')
```
