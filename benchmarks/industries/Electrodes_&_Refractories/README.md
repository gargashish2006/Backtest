# Electrodes & Refractories Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Electrodes & Refractories** industry, rebalanced quarterly using point-in-time constituent membership.
...
1. Identify all stocks classified in **Electrodes & Refractories**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Electrodes & Refractories Industry Index')
```
