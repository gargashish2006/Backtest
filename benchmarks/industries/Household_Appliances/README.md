# Household Appliances Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Household Appliances** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 468.38% |
| **Annualized Return** | 20.07% |
| **Volatility (Std Dev)** | 16.25% |
| **Sharpe Ratio** | 0.36 |
| **Max Drawdown** | -46.75% |
| **Win Rate** | 63.2% |
...
1. Identify all stocks classified in **Household Appliances**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Household Appliances Industry Index')
```
