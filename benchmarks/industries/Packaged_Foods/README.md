# Packaged Foods Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Packaged Foods** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 1189.95% |
| **Annualized Return** | 30.89% |
| **Volatility (Std Dev)** | 14.67% |
| **Sharpe Ratio** | 0.54 |
| **Max Drawdown** | -36.43% |
| **Win Rate** | 71.1% |
| **Avg Constituents** | 27 stocks |
...
1. Identify all stocks classified in **Packaged Foods**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Packaged Foods Industry Index')
```
