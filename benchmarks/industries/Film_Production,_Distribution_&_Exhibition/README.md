# Film Production, Distribution & Exhibition Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Film Production, Distribution & Exhibition** industry, rebalanced quarterly using point-in-time constituent membership.
...
1. Identify all stocks classified in **Film Production, Distribution & Exhibition**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Film Production, Distribution & Exhibition Industry Index')
```
