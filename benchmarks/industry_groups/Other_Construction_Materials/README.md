# Other Construction Materials Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Other Construction Materials** industry group, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 1048.15% |
| **Annualized Return** | 29.29% |
| **Volatility (Std Dev)** | 18.24% |
| **Sharpe Ratio** | 0.45 |
| **Max Drawdown** | -69.19% |
| **Win Rate** | 71.1% |
...
- Range: 9 to 20 stocks per quarter
...
1. Identify all stocks classified in **Other Construction Materials** industry group
...
plt.title('Other Construction Materials Industry Group Index')
