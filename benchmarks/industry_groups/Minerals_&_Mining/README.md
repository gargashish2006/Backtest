# Minerals & Mining Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Minerals & Mining** industry group, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 2679.86% |
| **Annualized Return** | 41.91% |
| **Volatility (Std Dev)** | 20.93% |
| **Sharpe Ratio** | 0.54 |
| **Max Drawdown** | -46.09% |
| **Win Rate** | 73.7% |
...
- Range: 10 to 14 stocks per quarter
...
1. Identify all stocks classified in **Minerals & Mining** industry group
...
plt.title('Minerals & Mining Industry Group Index')
