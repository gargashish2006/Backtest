# Financial Technology (Fintech) Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Financial Technology (Fintech)** industry group, rebalanced quarterly using point-in-time constituent membership.
...
| Metric | Value |
|--------|-------|
| **Total Periods** | 15 quarters |
| **Date Range** | 2022-03-31 to 2025-09-30 |
| **Total Return** | 18.70% |
| **Annualized Return** | 4.68% |
| **Volatility (Std Dev)** | 15.65% |
| **Sharpe Ratio** | 0.16 |
| **Max Drawdown** | -41.08% |
| **Win Rate** | 60.0% |
...
- **6 stocks** (on average)
- Range: 5 to 7 stocks per quarter
...
1. Identify all stocks classified in **Financial Technology (Fintech)** industry group
...
plt.title('Financial Technology (Fintech) Industry Group Index')
