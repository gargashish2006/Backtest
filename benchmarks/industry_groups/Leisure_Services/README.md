# Leisure Services Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Leisure Services** industry group, rebalanced quarterly using point-in-time constituent membership.
...
- Range: 50 to 95 stocks per quarter
...
1. Identify all stocks classified in **Leisure Services** industry group
...
plt.title('Leisure Services Industry Group Index')
