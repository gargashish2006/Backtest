# Agricultural, Commercial & Construction Vehicles Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Agricultural, Commercial & Construction Vehicles** industry group, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 1165.64% |
| **Annualized Return** | 30.63% |
| **Volatility (Std Dev)** | 17.01% |
| **Sharpe Ratio** | 0.49 |
| **Max Drawdown** | -56.34% |
| **Win Rate** | 68.4% |
...
- **9 stocks** (on average)
- Range: 8 to 11 stocks per quarter
...
1. Identify all stocks classified in **Agricultural, Commercial & Construction Vehicles** industry group
...
plt.title('Agricultural, Commercial & Construction Vehicles Industry Group Index')
