# Agricultural Food & other Products Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Agricultural Food & other Products** industry group, rebalanced quarterly using point-in-time constituent membership.
...
| **Max Drawdown** | -57.62% |
| **Win Rate** | 68.4% |
| **Avg Constituents** | 113 stocks |
| **Avg Industries** | 4 industries |
...
- **4 distinct industries** (on average)
- **113 stocks** (on average)
- Range: 88 to 150 stocks per quarter
...
1. Identify all stocks classified in **Agricultural Food & other Products** industry group
...
plt.title('Agricultural Food & other Products Industry Group Index')
