...
def run_research():
    ...
    # 1. Setup Strategy (RSI entry threshold = 45)
    strategy = CS15Strategy(dh, rsi_threshold=45)
    ...
    # 3. Run
    print("Running CS15 (RSI Entry > 45) Backtest...")
    ...
    print("\n" + "="*40)
    print("CS15 (RSI ENTRY > 45) PERFORMANCE")
    print("="*40)
