...
def run_rsi_band_test():
    ...
    # 3. Define Strategies
    tests = [
        {"name": "Champion (RSI > 40)", "rsi_low": 40, "rsi_high": 100}, # Baseline from previous step
        {"name": "Champion (40 < RSI < 70)", "rsi_low": 40, "rsi_high": 70}
    ]
    ...
    for test in tests:
        ...
        strategy = ContrarianBreadthStrategy(dh, rsi_threshold=test['rsi_low'], rsi_upper_threshold=test['rsi_high'])
    ...
    # 4. Report
    print("\n" + "="*80)
    print("MOMENTUM BAND SENSITIVITY (RSI 40-70)")
    print("="*80)
