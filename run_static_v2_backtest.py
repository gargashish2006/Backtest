...
from strategies.static_v2_strategy import StaticStrategyV2
from utils.analytics import calculate_metrics

def run_static_v2_backtest():
    ...
    # 2. Strategy
    print("Initializing Static V2 Strategy (Rule-Based Industry Context)...")
    strategy = StaticStrategyV2(dh)
    
    # 3. Backtest Period (Out of Sample Test)
    # Feb 2023 - Feb 2026
    ...
    print(f"Backtesting Static V2 from {start_date} to {end_date}...")
    ...
    output_path = repo_root / "outputs/static_v2_nav.csv"
    nav_df.to_csv(output_path, index=False)
    
    stats = calculate_metrics(nav_df)
    
    print("\n" + "="*60)
    print("STATIC V2 STRATEGY PERFORMANCE (Feb 2023 - Feb 2026)")
    print("="*60)
