...
def run_group_rsnp_backtest():
    ...
    # 3. Backtest Period (Out of Sample Test: Feb 2023 - Feb 2026)
    ...
    print(f"Backtesting Group RSNP Strategy from {start_date} to {end_date}...")
    ...
    output_path = repo_root / "outputs/group_rsnp_nav.csv"
    nav_df.to_csv(output_path, index=False)
    
    stats = calculate_metrics(nav_df)
    
    print("\n" + "="*60)
    print("GROUP RSNP STRATEGY PERFORMANCE (Feb 2023 - Feb 2026)")
    print("="*60)
