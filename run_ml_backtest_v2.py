...
def run_ml_backtest_v2():
    ...
    print(f"Backtesting V2 from {start_date} to {end_date}...")
    ...
    output_path = repo_root / "outputs/ml_strategy_v2_nav.csv"
    nav_df.to_csv(output_path, index=False)
    
    stats = calculate_metrics(nav_df)
    
    print("\n" + "="*60)
    print("ML STRATEGY V2 PERFORMANCE (Feb 2023 - Feb 2026)")
    print("="*60)
