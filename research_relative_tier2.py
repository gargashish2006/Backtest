...
from strategies.contrarian_relative_tier2 import ContrarianRelativeTier2Strategy
from utils.analytics import calculate_metrics

def run_relative_tier2_backtest():
    # 1. Setup Data
    ...
    # 2. Setup Strategy
    # Using Top 50% Groups -> Top 50% Industries (within groups)
    strategy = ContrarianRelativeTier2Strategy(dh, group_top_pct=0.50, industry_top_pct=0.50)
    ...
    # 4. Run Backtest
    print("Starting Double-Relative Filter Backtest (Top 50% Groups / Top 50% Inds)...")
    ...
    print("\n" + "="*50)
    print("DOUBLE-RELATIVE FILTER PERFORMANCE")
    print("="*50)
    ...
    print("\n" + "="*50)
    print("COMPARISON WITH CHAMPION (Absolute Industry Hurdle >= 50%)")
    print("="*50)
    print(f"{'Metric':<20} | {'Double Relative':<15} | {'Champ (Absolute)':<15}")
    print("-" * 55)
