"""
Compare CS15 (original RSNP) vs CS15-SHB (12Q Shareholder Breadth) from May 2019.
"""
import pandas as pd
...
from strategies.cs15_sh_breadth_strategy import CS15ShBreadthStrategy
...
def run_comparison():
    ...
    for name, StratClass in [("CS15 (RSNP)", CS15Strategy), ("CS15-SHB (12Q Breadth)", CS15ShBreadthStrategy)]:
        print(f"\n{'='*50}")
    ...
    colors = {'CS15 (RSNP)': '#2563eb', 'CS15-SHB (12Q Breadth)': '#dc2626'}
    ...
    ax.set_title('CS15 (RSNP) vs CS15-SHB (12Q Shareholder Breadth)\nMay 2019 - Feb 2026', 
    ...
    plt.tight_layout()
    out_path = repo_root / "cs15_vs_shb_comparison.png"
    plt.savefig(out_path, dpi=150)
    print(f"\nPlot saved to: {out_path}")
    
    # Summary table
    print(f"\n{'='*60}")
    print(f"{'Metric':<25} {'CS15 (RSNP)':>17} {'CS15-SHB (12Q)':>17}")
    print(f"{'='*60}")
    for metric in results['CS15 (RSNP)']['stats']:
        v1 = results['CS15 (RSNP)']['stats'][metric]
        v2 = results['CS15-SHB (12Q Breadth)']['stats'][metric]
