"""
MCPS12-4Q Portfolio Snapshot (Feb 15, 2020)
...
# num_stocks=12, group_top_pct=0.50, group_lookback=4, mcps_lookback=4, universe_size=1000
...
if not selection:
    ...
    print("\n" + "=" * 105)
    print(f"MCPS12-4Q HISTORICAL PORTFOLIO Snapshot (Effective: 15-Feb-2020)")
    print("=" * 105)
