...
def run_gradual_30_stock():
    ...
    # Using StructuralAlphaStrategy which supports these params
    ...
    print(f"Starting 30-Stock Gradual Entry (Top 10 Ind, 3-Max, 25% x 4) from {start_date.date()}...")
