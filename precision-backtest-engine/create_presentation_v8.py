...
def add_footer(slide, page_num):
    ...
    tf = txBox.text_frame
    p = tf.paragraphs[0]
    p.text = "CONFIDENTIAL | The Ignored Momentum Strategy"
    p.font.size = Pt(10)
...
# Save
output_path = '/Users/shubhrakasana/Desktop/oleander/olgo_mobile/repos/Backtest/precision-backtest-engine/Ignored_Momentum_Presentation_v8.pptx'
prs.save(output_path)
print(f"Presentation v8 saved to: {output_path}")
