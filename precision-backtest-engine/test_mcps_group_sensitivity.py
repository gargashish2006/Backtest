"""
MCPS15 Group Breadth Sensitivity Test:
Tests group_top_pct thresholds: 10%, 20%, 30%, 40%, 50%.
...
variants = [
    ("MCPS15 Group 10%", 0.10),
    ("MCPS15 Group 20%", 0.20),
    ("MCPS15 Group 30%", 0.30),
    ("MCPS15 Group 40%", 0.40),
...
# ── Plot ──────────────────────────────────────────────────────────────────────
colors = ['#ff6b6b', '#ffd93d', '#6bcb77', '#4d96ff', '#a06ee1']
...
ax.set_title('MCPS15 Group Breadth Sensitivity (10% to 50%)', fontsize=16, color='white', pad=20)
...
out_path = repo_root / "mcps15_group_sensitivity.png"
plt.tight_layout()
