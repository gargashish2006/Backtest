...
def add_footer(slide, page_num):
    ...
    tf = txBox.text_frame
    p = tf.paragraphs[0]
    p.text = "CONFIDENTIAL | The Hidden Momentum Strategy"
    p.font.size = Pt(10)
...
# Slide 6: Strategy Features (UPDATED TURNOVER)
create_content_slide(
    prs,
...
# Save
output_path = '/Users/shubhrakasana/Desktop/oleander/olgo_mobile/repos/Backtest/precision-backtest-engine/Hidden_Momentum_Presentation_v7.pptx'
prs.save(output_path)
print(f"Presentation v7 saved to: {output_path}")
