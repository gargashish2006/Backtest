"""
MCPS12-4Q Top 500 Portfolio Rebalance (Feb 15, 2026)
Generates the stock list for the MCPS strategy restricted to Top 500 stocks.
"""
import pandas as pd
...
# Restricted to Top 500 universe
...
if not selection:
    ...
    print("\n" + "=" * 100)
    print(f"MCPS12-4Q TOP 500 PORTFOLIO REBALANCE (Effective: 15-Feb-2026)")
    print("=" * 100)
