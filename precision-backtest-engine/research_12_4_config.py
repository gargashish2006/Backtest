...
def run_specific_concentration_research():
    # 1. Setup
    ...
    configs = [
        {"name": "12 Stocks, Max 4/Ind", "n": 12, "max_ind": 4},
        {"name": "15 Stocks, Max 3/Ind", "n": 15, "max_ind": 3},
        {"name": "10 Stocks, Max 3/Ind", "n": 10, "max_ind": 3}
    ]
    ...
    # 4. Report
    print("\n" + "="*100)
    print("SPECIFIC CONCENTRATION ANALYSIS (12/4 vs 15/3 vs 10/3)")
    print("="*100)
    
    metrics = ["Absolute Return", "CAGR", "Max Drawdown", "Sharpe Ratio"]
    headers = [c['name'] for c in configs]
    
    print(f"{'Metric':<20} | {headers[1]:>22} | {headers[0]:>22} | {headers[2]:>22}")
    print("-" * 100)
    ...
    for m in metrics:
        ...
        print(f"{m:<20} | {v1:>22} | {v0:>22} | {v2:>22}")
    print("="*100)

if __name__ == "__main__":
    run_specific_concentration_research()
