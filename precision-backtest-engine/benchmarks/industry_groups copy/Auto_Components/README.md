# Auto Components Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Auto Components** industry group, rebalanced quarterly using point-in-time constituent membership.
...
| **Volatility (Std Dev)** | 16.60% |
| **Sharpe Ratio** | 0.40 |
| **Max Drawdown** | -64.75% |
| **Win Rate** | 65.8% |
| **Avg Constituents** | 123 stocks |
...
- **123 stocks** (on average)
- Range: 103 to 147 stocks per quarter
...
1. Identify all stocks classified in **Auto Components** industry group
...
plt.title('Auto Components Industry Group Index')
