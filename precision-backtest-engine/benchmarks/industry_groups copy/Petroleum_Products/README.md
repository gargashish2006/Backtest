# Petroleum Products Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Petroleum Products** industry group, rebalanced quarterly using point-in-time constituent membership.
...
- Range: 13 to 20 stocks per quarter
...
1. Identify all stocks classified in **Petroleum Products** industry group
...
plt.title('Petroleum Products Industry Group Index')
