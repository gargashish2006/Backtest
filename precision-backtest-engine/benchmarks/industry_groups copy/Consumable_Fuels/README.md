# Consumable Fuels Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Consumable Fuels** industry group, rebalanced quarterly using point-in-time constituent membership.
...
| Metric | Value |
|--------|-------|
| **Total Periods** | 8 quarters |
| **Date Range** | 2023-12-31 to 2025-09-30 |
| **Total Return** | -0.55% |
| **Annualized Return** | -0.28% |
| **Volatility (Std Dev)** | 15.97% |
| **Sharpe Ratio** | 0.08 |
| **Max Drawdown** | -39.03% |
| **Win Rate** | 50.0% |
...
- **5 stocks** (on average)
- Range: 4 to 5 stocks per quarter
...
1. Identify all stocks classified in **Consumable Fuels** industry group
...
plt.title('Consumable Fuels Industry Group Index')
