...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Gas** industry group, rebalanced quarterly using point-in-time constituent membership.
...
- **8 stocks** (on average)
- Range: 6 to 10 stocks per quarter
...
1. Identify all stocks classified in **Gas** industry group
...
plt.title('Gas Industry Group Index')
