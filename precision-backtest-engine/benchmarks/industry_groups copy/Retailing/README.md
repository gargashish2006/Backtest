# Retailing Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Retailing** industry group, rebalanced quarterly using point-in-time constituent membership.
...
| **Volatility (Std Dev)** | 16.06% |
| **Sharpe Ratio** | 0.41 |
| **Max Drawdown** | -47.93% |
| **Win Rate** | 68.4% |
| **Avg Constituents** | 35 stocks |
...
- **35 stocks** (on average)
- Range: 16 to 61 stocks per quarter
...
1. Identify all stocks classified in **Retailing** industry group
...
plt.title('Retailing Industry Group Index')
