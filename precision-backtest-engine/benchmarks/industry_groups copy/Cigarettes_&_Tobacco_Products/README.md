# Cigarettes & Tobacco Products Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Cigarettes & Tobacco Products** industry group, rebalanced quarterly using point-in-time constituent membership.
...
| Metric | Value |
|--------|-------|
| **Total Periods** | 13 quarters |
| **Date Range** | 2020-03-31 to 2025-09-30 |
| **Total Return** | 711.21% |
| **Annualized Return** | 90.43% |
| **Volatility (Std Dev)** | 22.82% |
| **Sharpe Ratio** | 0.86 |
| **Max Drawdown** | -19.04% |
| **Win Rate** | 76.9% |
...
- **5 stocks** (on average)
- Range: 4 to 6 stocks per quarter
...
1. Identify all stocks classified in **Cigarettes & Tobacco Products** industry group
...
plt.title('Cigarettes & Tobacco Products Industry Group Index')
