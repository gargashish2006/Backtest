# Diversified Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Diversified** industry group, rebalanced quarterly using point-in-time constituent membership.
...
- Range: 12 to 15 stocks per quarter
...
1. Identify all stocks classified in **Diversified** industry group
...
plt.title('Diversified Industry Group Index')
