# Other Consumer Services Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Other Consumer Services** industry group, rebalanced quarterly using point-in-time constituent membership.
...
| **Volatility (Std Dev)** | 18.61% |
| **Sharpe Ratio** | 0.34 |
| **Max Drawdown** | -57.85% |
| **Win Rate** | 60.5% |
| **Avg Constituents** | 21 stocks |
...
- **21 stocks** (on average)
- Range: 12 to 32 stocks per quarter
...
1. Identify all stocks classified in **Other Consumer Services** industry group
...
plt.title('Other Consumer Services Industry Group Index')
