# Printing & Publication Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Printing & Publication** industry group, rebalanced quarterly using point-in-time constituent membership.
...
| Metric | Value |
|--------|-------|
| **Total Periods** | 25 quarters |
| **Date Range** | 2019-06-30 to 2025-09-30 |
| **Total Return** | 120.68% |
| **Annualized Return** | 13.50% |
| **Volatility (Std Dev)** | 17.44% |
| **Sharpe Ratio** | 0.27 |
| **Max Drawdown** | -39.17% |
| **Win Rate** | 56.0% |
...
1. Identify all stocks classified in **Printing & Publication** industry group
...
plt.title('Printing & Publication Industry Group Index')
