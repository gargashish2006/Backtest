# Household Products Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Household Products** industry group, rebalanced quarterly using point-in-time constituent membership.
...
| **Volatility (Std Dev)** | 15.42% |
| **Sharpe Ratio** | 0.32 |
| **Max Drawdown** | -57.87% |
| **Win Rate** | 63.2% |
| **Avg Constituents** | 14 stocks |
...
- **14 stocks** (on average)
- Range: 11 to 17 stocks per quarter
...
1. Identify all stocks classified in **Household Products** industry group
...
plt.title('Household Products Industry Group Index')
