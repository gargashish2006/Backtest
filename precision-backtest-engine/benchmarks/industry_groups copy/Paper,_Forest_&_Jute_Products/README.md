# Paper, Forest & Jute Products Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Paper, Forest & Jute Products** industry group, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 964.82% |
| **Annualized Return** | 28.27% |
| **Volatility (Std Dev)** | 18.59% |
| **Sharpe Ratio** | 0.43 |
| **Max Drawdown** | -57.89% |
| **Win Rate** | 68.4% |
| **Avg Constituents** | 42 stocks |
...
- **42 stocks** (on average)
- Range: 31 to 55 stocks per quarter
...
1. Identify all stocks classified in **Paper, Forest & Jute Products** industry group
...
plt.title('Paper, Forest & Jute Products Industry Group Index')
