# Healthcare Equipment & Supplies Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Healthcare Equipment & Supplies** industry group, rebalanced quarterly using point-in-time constituent membership.
...
- **8 stocks** (on average)
- Range: 4 to 14 stocks per quarter
...
1. Identify all stocks classified in **Healthcare Equipment & Supplies** industry group
...
plt.title('Healthcare Equipment & Supplies Industry Group Index')
