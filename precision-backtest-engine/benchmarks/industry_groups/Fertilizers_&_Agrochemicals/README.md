# Fertilizers & Agrochemicals Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Fertilizers & Agrochemicals** industry group, rebalanced quarterly using point-in-time constituent membership.
...
- Range: 30 to 50 stocks per quarter
...
1. Identify all stocks classified in **Fertilizers & Agrochemicals** industry group
...
plt.title('Fertilizers & Agrochemicals Industry Group Index')
