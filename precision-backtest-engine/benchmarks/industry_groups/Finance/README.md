# Finance Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Finance** industry group, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 2011.39% |
| **Annualized Return** | 37.86% |
| **Volatility (Std Dev)** | 15.50% |
| **Sharpe Ratio** | 0.61 |
| **Max Drawdown** | -45.67% |
| **Win Rate** | 73.7% |
| **Avg Constituents** | 332 stocks |
| **Avg Industries** | 7 industries |
...
- **7 distinct industries** (on average)
- **332 stocks** (on average)
- Range: 227 to 471 stocks per quarter
...
1. Identify all stocks classified in **Finance** industry group
...
plt.title('Finance Industry Group Index')
