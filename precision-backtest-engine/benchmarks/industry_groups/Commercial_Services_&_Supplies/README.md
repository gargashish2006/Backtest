# Commercial Services & Supplies Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Commercial Services & Supplies** industry group, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 1859.17% |
| **Annualized Return** | 36.78% |
| **Volatility (Std Dev)** | 15.93% |
| **Sharpe Ratio** | 0.58 |
| **Max Drawdown** | -39.17% |
| **Win Rate** | 68.4% |
| **Avg Constituents** | 178 stocks |
| **Avg Industries** | 5 industries |
...
- **5 distinct industries** (on average)
- **178 stocks** (on average)
- Range: 98 to 291 stocks per quarter
...
1. Identify all stocks classified in **Commercial Services & Supplies** industry group
...
plt.title('Commercial Services & Supplies Industry Group Index')
