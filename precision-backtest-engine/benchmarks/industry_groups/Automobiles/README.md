# Automobiles Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Automobiles** industry group, rebalanced quarterly using point-in-time constituent membership.
...
- Range: 10 to 22 stocks per quarter
...
1. Identify all stocks classified in **Automobiles** industry group
...
plt.title('Automobiles Industry Group Index')
