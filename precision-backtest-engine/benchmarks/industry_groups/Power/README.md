# Power Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Power** industry group, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 992.45% |
| **Annualized Return** | 28.62% |
| **Volatility (Std Dev)** | 23.13% |
| **Sharpe Ratio** | 0.38 |
| **Max Drawdown** | -64.72% |
| **Win Rate** | 55.3% |
| **Avg Constituents** | 34 stocks |
...
- **34 stocks** (on average)
- Range: 28 to 42 stocks per quarter
...
1. Identify all stocks classified in **Power** industry group
...
plt.title('Power Industry Group Index')
