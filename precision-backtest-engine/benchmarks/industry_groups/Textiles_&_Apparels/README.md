# Textiles & Apparels Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Textiles & Apparels** industry group, rebalanced quarterly using point-in-time constituent membership.
...
| **Volatility (Std Dev)** | 17.81% |
| **Sharpe Ratio** | 0.42 |
| **Max Drawdown** | -61.46% |
| **Win Rate** | 65.8% |
| **Avg Constituents** | 217 stocks |
...
- **217 stocks** (on average)
- Range: 175 to 280 stocks per quarter
...
1. Identify all stocks classified in **Textiles & Apparels** industry group
...
plt.title('Textiles & Apparels Industry Group Index')
