# Transport Infrastructure Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Transport Infrastructure** industry group, rebalanced quarterly using point-in-time constituent membership.
...
- **8 stocks** (on average)
- Range: 6 to 12 stocks per quarter
...
1. Identify all stocks classified in **Transport Infrastructure** industry group
...
plt.title('Transport Infrastructure Industry Group Index')
