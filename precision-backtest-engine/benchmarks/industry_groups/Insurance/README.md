# Insurance Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Insurance** industry group, rebalanced quarterly using point-in-time constituent membership.
...
- **8 stocks** (on average)
- Range: 7 to 12 stocks per quarter
...
1. Identify all stocks classified in **Insurance** industry group
...
plt.title('Insurance Industry Group Index')
