# IT - Hardware Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **IT - Hardware** industry group, rebalanced quarterly using point-in-time constituent membership.
...
- Range: 14 to 21 stocks per quarter
...
1. Identify all stocks classified in **IT - Hardware** industry group
...
plt.title('IT - Hardware Industry Group Index')
