# Capital Markets Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Capital Markets** industry group, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 1011.18% |
| **Annualized Return** | 28.85% |
| **Volatility (Std Dev)** | 18.06% |
| **Sharpe Ratio** | 0.45 |
| **Max Drawdown** | -59.40% |
| **Win Rate** | 63.2% |
...
- Range: 22 to 60 stocks per quarter
...
1. Identify all stocks classified in **Capital Markets** industry group
...
plt.title('Capital Markets Industry Group Index')
