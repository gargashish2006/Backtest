# Ferrous Metals Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Ferrous Metals** industry group, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 1993.60% |
| **Annualized Return** | 37.73% |
| **Volatility (Std Dev)** | 23.34% |
| **Sharpe Ratio** | 0.46 |
| **Max Drawdown** | -68.12% |
| **Win Rate** | 68.4% |
| **Avg Constituents** | 26 stocks |
...
- **26 stocks** (on average)
- Range: 24 to 29 stocks per quarter
...
1. Identify all stocks classified in **Ferrous Metals** industry group
...
plt.title('Ferrous Metals Industry Group Index')
