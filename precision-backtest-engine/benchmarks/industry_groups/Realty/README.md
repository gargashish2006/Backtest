# Realty Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Realty** industry group, rebalanced quarterly using point-in-time constituent membership.
...
| **Volatility (Std Dev)** | 16.67% |
| **Sharpe Ratio** | 0.45 |
| **Max Drawdown** | -57.08% |
| **Win Rate** | 65.8% |
| **Avg Constituents** | 116 stocks |
...
- **116 stocks** (on average)
- Range: 92 to 155 stocks per quarter
...
1. Identify all stocks classified in **Realty** industry group
...
plt.title('Realty Industry Group Index')
