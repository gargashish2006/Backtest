# Cement & Cement Products Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Cement & Cement Products** industry group, rebalanced quarterly using point-in-time constituent membership.
...
| **Volatility (Std Dev)** | 15.87% |
| **Sharpe Ratio** | 0.28 |
| **Max Drawdown** | -62.02% |
| **Win Rate** | 68.4% |
| **Avg Constituents** | 33 stocks |
...
- **33 stocks** (on average)
- Range: 27 to 40 stocks per quarter
...
1. Identify all stocks classified in **Cement & Cement Products** industry group
...
plt.title('Cement & Cement Products Industry Group Index')
