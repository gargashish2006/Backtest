...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Paints** industry, rebalanced quarterly using point-in-time constituent membership.
...
1. Identify all stocks classified in **Paints**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Paints Industry Index')
```
