# Other Financial Services Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Other Financial Services** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 2331.29% |
| **Annualized Return** | 39.92% |
| **Volatility (Std Dev)** | 15.52% |
| **Sharpe Ratio** | 0.63 |
| **Max Drawdown** | -41.65% |
| **Win Rate** | 71.1% |
| **Avg Constituents** | 71 stocks |
...
1. Identify all stocks classified in **Other Financial Services**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Other Financial Services Industry Index')
```
