# Auto Components & Equipments Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Auto Components & Equipments** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Volatility (Std Dev)** | 17.23% |
| **Sharpe Ratio** | 0.40 |
| **Max Drawdown** | -65.14% |
| **Win Rate** | 63.2% |
| **Avg Constituents** | 106 stocks |
...
1. Identify all stocks classified in **Auto Components & Equipments**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Auto Components & Equipments Industry Index')
```
