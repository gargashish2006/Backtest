# General Insurance Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **General Insurance** industry, rebalanced quarterly using point-in-time constituent membership.
...
1. Identify all stocks classified in **General Insurance**
...
# Plot
benchmark.plot(x='date', y='index_value', title='General Insurance Industry Index')
```
