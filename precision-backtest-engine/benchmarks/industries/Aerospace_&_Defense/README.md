...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Aerospace & Defense** industry, rebalanced quarterly using point-in-time constituent membership.
...
1. Identify all stocks classified in **Aerospace & Defense**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Aerospace & Defense Industry Index')
```
