# Plastic Products - Industrial Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Plastic Products - Industrial** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 1099.25% |
| **Annualized Return** | 29.89% |
| **Volatility (Std Dev)** | 16.93% |
| **Sharpe Ratio** | 0.48 |
| **Max Drawdown** | -62.66% |
| **Win Rate** | 65.8% |
| **Avg Constituents** | 43 stocks |
...
1. Identify all stocks classified in **Plastic Products - Industrial**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Plastic Products - Industrial Industry Index')
```
