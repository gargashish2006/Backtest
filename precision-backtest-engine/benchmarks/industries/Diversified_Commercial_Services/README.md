# Diversified Commercial Services Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Diversified Commercial Services** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 1126.25% |
| **Annualized Return** | 30.19% |
| **Volatility (Std Dev)** | 15.46% |
| **Sharpe Ratio** | 0.51 |
| **Max Drawdown** | -38.95% |
| **Win Rate** | 68.4% |
| **Avg Constituents** | 51 stocks |
...
1. Identify all stocks classified in **Diversified Commercial Services**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Diversified Commercial Services Industry Index')
```
