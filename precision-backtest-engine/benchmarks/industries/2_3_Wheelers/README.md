# 2/3 Wheelers Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **2/3 Wheelers** industry, rebalanced quarterly using point-in-time constituent membership.
...
1. Identify all stocks classified in **2/3 Wheelers**
...
# Plot
benchmark.plot(x='date', y='index_value', title='2/3 Wheelers Industry Index')
```
