# Printing & Publication Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Printing & Publication** industry, rebalanced quarterly using point-in-time constituent membership.
...
1. Identify all stocks classified in **Printing & Publication**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Printing & Publication Industry Index')
```
