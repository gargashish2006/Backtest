# Cigarettes & Tobacco Products Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Cigarettes & Tobacco Products** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 2489.02% |
| **Annualized Return** | 40.85% |
| **Volatility (Std Dev)** | 21.83% |
| **Sharpe Ratio** | 0.50 |
| **Max Drawdown** | -35.50% |
| **Win Rate** | 68.4% |
...
1. Identify all stocks classified in **Cigarettes & Tobacco Products**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Cigarettes & Tobacco Products Industry Index')
```
