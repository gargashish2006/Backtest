...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Edible Oil** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 3845.50% |
| **Annualized Return** | 47.23% |
| **Volatility (Std Dev)** | 20.36% |
| **Sharpe Ratio** | 0.59 |
| **Max Drawdown** | -52.89% |
| **Win Rate** | 65.8% |
...
1. Identify all stocks classified in **Edible Oil**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Edible Oil Industry Index')
```
