# Non Banking Financial Company (NBFC) Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Non Banking Financial Company (NBFC)** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 2286.38% |
| **Annualized Return** | 39.64% |
| **Volatility (Std Dev)** | 15.18% |
| **Sharpe Ratio** | 0.64 |
| **Max Drawdown** | -37.56% |
| **Win Rate** | 71.1% |
| **Avg Constituents** | 175 stocks |
...
1. Identify all stocks classified in **Non Banking Financial Company (NBFC)**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Non Banking Financial Company (NBFC) Industry Index')
```
