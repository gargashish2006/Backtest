# Other Food Products Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Other Food Products** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 1079.69% |
| **Annualized Return** | 29.66% |
| **Volatility (Std Dev)** | 18.57% |
| **Sharpe Ratio** | 0.45 |
| **Max Drawdown** | -62.38% |
| **Win Rate** | 68.4% |
...
1. Identify all stocks classified in **Other Food Products**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Other Food Products Industry Index')
```
