# Road Transport Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Road Transport** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 1032.95% |
| **Annualized Return** | 29.11% |
| **Volatility (Std Dev)** | 21.26% |
| **Sharpe Ratio** | 0.40 |
| **Max Drawdown** | -37.40% |
| **Win Rate** | 60.5% |
...
1. Identify all stocks classified in **Road Transport**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Road Transport Industry Index')
```
