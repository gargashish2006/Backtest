# Diversified Metals Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Diversified Metals** industry, rebalanced quarterly using point-in-time constituent membership.
...
| Metric | Value |
|--------|-------|
| **Total Periods** | 10 quarters |
| **Date Range** | 2023-06-30 to 2025-09-30 |
| **Total Return** | 288.31% |
| **Annualized Return** | 72.06% |
| **Volatility (Std Dev)** | 19.06% |
| **Sharpe Ratio** | 0.85 |
| **Max Drawdown** | -27.09% |
| **Win Rate** | 80.0% |
...
1. Identify all stocks classified in **Diversified Metals**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Diversified Metals Industry Index')
```
