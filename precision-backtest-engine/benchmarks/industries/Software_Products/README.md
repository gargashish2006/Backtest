# Software Products Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Software Products** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 3855.87% |
| **Annualized Return** | 47.28% |
| **Volatility (Std Dev)** | 23.15% |
| **Sharpe Ratio** | 0.54 |
| **Max Drawdown** | -47.10% |
| **Win Rate** | 63.2% |
| **Avg Constituents** | 32 stocks |
...
1. Identify all stocks classified in **Software Products**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Software Products Industry Index')
```
