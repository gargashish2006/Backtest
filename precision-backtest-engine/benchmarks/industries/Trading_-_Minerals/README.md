# Trading - Minerals Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Trading - Minerals** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 1192.68% |
| **Annualized Return** | 39.13% |
| **Volatility (Std Dev)** | 20.34% |
| **Sharpe Ratio** | 0.51 |
| **Max Drawdown** | -41.48% |
| **Win Rate** | 64.5% |
...
1. Identify all stocks classified in **Trading - Minerals**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Trading - Minerals Industry Index')
```
