# Media & Entertainment Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Media & Entertainment** industry, rebalanced quarterly using point-in-time constituent membership.
...
1. Identify all stocks classified in **Media & Entertainment**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Media & Entertainment Industry Index')
```
