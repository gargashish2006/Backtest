# Financial Institution Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Financial Institution** industry, rebalanced quarterly using point-in-time constituent membership.
...
1. Identify all stocks classified in **Financial Institution**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Financial Institution Industry Index')
```
