# Computers - Software & Consulting Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Computers - Software & Consulting** industry, rebalanced quarterly using point-in-time constituent membership.
...
1. Identify all stocks classified in **Computers - Software & Consulting**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Computers - Software & Consulting Industry Index')
```
