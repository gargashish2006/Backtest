# Trading & Distributors Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Trading & Distributors** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 2293.16% |
| **Annualized Return** | 39.69% |
| **Volatility (Std Dev)** | 16.59% |
| **Sharpe Ratio** | 0.59 |
| **Max Drawdown** | -38.64% |
| **Win Rate** | 76.3% |
| **Avg Constituents** | 104 stocks |
...
1. Identify all stocks classified in **Trading & Distributors**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Trading & Distributors Industry Index')
```
