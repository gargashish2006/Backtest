# Castings & Forgings Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Castings & Forgings** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 1210.09% |
| **Annualized Return** | 31.10% |
| **Volatility (Std Dev)** | 16.74% |
| **Sharpe Ratio** | 0.49 |
| **Max Drawdown** | -39.11% |
| **Win Rate** | 65.8% |
...
1. Identify all stocks classified in **Castings & Forgings**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Castings & Forgings Industry Index')
```
