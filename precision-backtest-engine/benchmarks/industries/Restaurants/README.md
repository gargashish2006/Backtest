# Restaurants Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Restaurants** industry, rebalanced quarterly using point-in-time constituent membership.
...
1. Identify all stocks classified in **Restaurants**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Restaurants Industry Index')
```
