# IT Enabled Services Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **IT Enabled Services** industry, rebalanced quarterly using point-in-time constituent membership.
...
1. Identify all stocks classified in **IT Enabled Services**
...
# Plot
benchmark.plot(x='date', y='index_value', title='IT Enabled Services Industry Index')
```
