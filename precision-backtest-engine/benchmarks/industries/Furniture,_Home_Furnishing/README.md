# Furniture, Home Furnishing Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Furniture, Home Furnishing** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Date Range** | 2016-09-30 to 2025-09-30 |
| **Total Return** | 189.28% |
...
1. Identify all stocks classified in **Furniture, Home Furnishing**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Furniture, Home Furnishing Industry Index')
```
