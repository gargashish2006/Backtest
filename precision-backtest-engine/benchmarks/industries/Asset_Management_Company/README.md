# Asset Management Company Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Asset Management Company** industry, rebalanced quarterly using point-in-time constituent membership.
...
1. Identify all stocks classified in **Asset Management Company**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Asset Management Company Industry Index')
```
