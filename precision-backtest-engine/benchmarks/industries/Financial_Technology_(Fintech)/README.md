# Financial Technology (Fintech) Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Financial Technology (Fintech)** industry, rebalanced quarterly using point-in-time constituent membership.
...
1. Identify all stocks classified in **Financial Technology (Fintech)**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Financial Technology (Fintech) Industry Index')
```
