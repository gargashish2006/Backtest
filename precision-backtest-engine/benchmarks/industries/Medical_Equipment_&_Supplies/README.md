# Medical Equipment & Supplies Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Medical Equipment & Supplies** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 1140.66% |
| **Annualized Return** | 30.35% |
| **Volatility (Std Dev)** | 18.18% |
| **Sharpe Ratio** | 0.46 |
| **Max Drawdown** | -27.14% |
| **Win Rate** | 60.5% |
...
1. Identify all stocks classified in **Medical Equipment & Supplies**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Medical Equipment & Supplies Industry Index')
```
