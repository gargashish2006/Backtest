# Specialty Chemicals Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Specialty Chemicals** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Volatility (Std Dev)** | 15.35% |
| **Sharpe Ratio** | 0.43 |
| **Max Drawdown** | -43.72% |
| **Win Rate** | 57.9% |
| **Avg Constituents** | 74 stocks |
...
1. Identify all stocks classified in **Specialty Chemicals**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Specialty Chemicals Industry Index')
```
