# Aluminium, Copper & Zinc Products Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Aluminium, Copper & Zinc Products** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 2038.53% |
| **Annualized Return** | 38.04% |
| **Volatility (Std Dev)** | 17.61% |
| **Sharpe Ratio** | 0.56 |
| **Max Drawdown** | -49.91% |
| **Win Rate** | 65.8% |
...
1. Identify all stocks classified in **Aluminium, Copper & Zinc Products**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Aluminium, Copper & Zinc Products Industry Index')
```
