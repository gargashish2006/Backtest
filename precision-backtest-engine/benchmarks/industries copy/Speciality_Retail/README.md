# Speciality Retail Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Speciality Retail** industry, rebalanced quarterly using point-in-time constituent membership.
...
1. Identify all stocks classified in **Speciality Retail**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Speciality Retail Industry Index')
```
