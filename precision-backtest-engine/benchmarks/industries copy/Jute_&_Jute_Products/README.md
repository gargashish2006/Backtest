# Jute & Jute Products Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Jute & Jute Products** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Date Range** | 2022-09-30 to 2025-09-30 |
| **Total Return** | 90.53% |
| **Annualized Return** | 21.94% |
| **Volatility (Std Dev)** | 21.87% |
| **Sharpe Ratio** | 0.33 |
| **Max Drawdown** | -28.27% |
| **Win Rate** | 69.2% |
...
1. Identify all stocks classified in **Jute & Jute Products**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Jute & Jute Products Industry Index')
```
