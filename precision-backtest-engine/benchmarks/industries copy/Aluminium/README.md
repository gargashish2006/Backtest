...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Aluminium** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 1429.36% |
| **Annualized Return** | 33.26% |
| **Volatility (Std Dev)** | 21.03% |
| **Sharpe Ratio** | 0.45 |
| **Max Drawdown** | -71.53% |
| **Win Rate** | 65.8% |
...
1. Identify all stocks classified in **Aluminium**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Aluminium Industry Index')
```
