# Stockbroking & Allied Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Stockbroking & Allied** industry, rebalanced quarterly using point-in-time constituent membership.
...
1. Identify all stocks classified in **Stockbroking & Allied**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Stockbroking & Allied Industry Index')
```
