# Exchange and Data Platform Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Exchange and Data Platform** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 1482.40% |
| **Annualized Return** | 42.81% |
| **Volatility (Std Dev)** | 19.60% |
| **Sharpe Ratio** | 0.56 |
| **Max Drawdown** | -29.82% |
| **Win Rate** | 64.5% |
...
1. Identify all stocks classified in **Exchange and Data Platform**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Exchange and Data Platform Industry Index')
```
