# Forest Products Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Forest Products** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Date Range** | 2019-03-31 to 2025-09-30 |
| **Total Return** | 10.45% |
| **Annualized Return** | 1.60% |
| **Volatility (Std Dev)** | 20.32% |
| **Sharpe Ratio** | 0.11 |
| **Max Drawdown** | -46.82% |
| **Win Rate** | 44.0% |
...
1. Identify all stocks classified in **Forest Products**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Forest Products Industry Index')
```
