# Investment Company Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Investment Company** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 1815.57% |
| **Annualized Return** | 36.45% |
| **Volatility (Std Dev)** | 22.18% |
| **Sharpe Ratio** | 0.45 |
| **Max Drawdown** | -56.24% |
| **Win Rate** | 63.2% |
| **Avg Constituents** | 52 stocks |
...
1. Identify all stocks classified in **Investment Company**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Investment Company Industry Index')
```
