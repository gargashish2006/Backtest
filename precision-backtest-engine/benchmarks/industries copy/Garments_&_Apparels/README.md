# Garments & Apparels Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Garments & Apparels** industry, rebalanced quarterly using point-in-time constituent membership.
...
1. Identify all stocks classified in **Garments & Apparels**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Garments & Apparels Industry Index')
```
