# Residential, Commercial Projects Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Residential, Commercial Projects** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Volatility (Std Dev)** | 16.75% |
| **Sharpe Ratio** | 0.44 |
| **Max Drawdown** | -57.29% |
| **Win Rate** | 65.8% |
| **Avg Constituents** | 112 stocks |
...
1. Identify all stocks classified in **Residential, Commercial Projects**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Residential, Commercial Projects Industry Index')
```
