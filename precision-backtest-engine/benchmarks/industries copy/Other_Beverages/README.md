# Other Beverages Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Other Beverages** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 560.08% |
| **Annualized Return** | 24.07% |
| **Volatility (Std Dev)** | 21.58% |
| **Sharpe Ratio** | 0.33 |
| **Max Drawdown** | -34.21% |
| **Win Rate** | 54.3% |
...
1. Identify all stocks classified in **Other Beverages**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Other Beverages Industry Index')
```
