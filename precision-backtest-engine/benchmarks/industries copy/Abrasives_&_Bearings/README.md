# Abrasives & Bearings Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Abrasives & Bearings** industry, rebalanced quarterly using point-in-time constituent membership.
...
1. Identify all stocks classified in **Abrasives & Bearings**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Abrasives & Bearings Industry Index')
```
