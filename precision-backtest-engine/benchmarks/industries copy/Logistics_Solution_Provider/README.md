# Logistics Solution Provider Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Logistics Solution Provider** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Volatility (Std Dev)** | 19.80% |
| **Sharpe Ratio** | 0.30 |
| **Max Drawdown** | -64.35% |
| **Win Rate** | 60.5% |
| **Avg Constituents** | 30 stocks |
...
1. Identify all stocks classified in **Logistics Solution Provider**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Logistics Solution Provider Industry Index')
```
