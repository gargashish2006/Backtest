# Healthcare Research, Analytics & Technology Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Healthcare Research, Analytics & Technology** industry, rebalanced quarterly using point-in-time constituent membership.
...
1. Identify all stocks classified in **Healthcare Research, Analytics & Technology**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Healthcare Research, Analytics & Technology Industry Index')
```
