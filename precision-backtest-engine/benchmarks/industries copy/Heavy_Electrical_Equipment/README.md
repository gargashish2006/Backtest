# Heavy Electrical Equipment Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Heavy Electrical Equipment** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 823.02% |
| **Annualized Return** | 26.36% |
| **Volatility (Std Dev)** | 21.84% |
| **Sharpe Ratio** | 0.37 |
| **Max Drawdown** | -66.05% |
| **Win Rate** | 57.9% |
...
1. Identify all stocks classified in **Heavy Electrical Equipment**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Heavy Electrical Equipment Industry Index')
```
