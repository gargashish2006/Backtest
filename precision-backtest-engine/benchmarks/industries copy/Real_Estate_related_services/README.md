# Real Estate related services Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Real Estate related services** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 1079.86% |
| **Annualized Return** | 29.67% |
| **Volatility (Std Dev)** | 28.53% |
| **Sharpe Ratio** | 0.34 |
| **Max Drawdown** | -57.83% |
| **Win Rate** | 52.6% |
...
1. Identify all stocks classified in **Real Estate related services**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Real Estate related services Industry Index')
```
