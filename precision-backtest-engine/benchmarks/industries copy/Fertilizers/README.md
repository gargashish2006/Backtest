# Fertilizers Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Fertilizers** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 1169.09% |
| **Annualized Return** | 30.66% |
| **Volatility (Std Dev)** | 21.07% |
| **Sharpe Ratio** | 0.42 |
| **Max Drawdown** | -61.25% |
| **Win Rate** | 63.2% |
...
1. Identify all stocks classified in **Fertilizers**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Fertilizers Industry Index')
```
