# Pesticides & Agrochemicals Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Pesticides & Agrochemicals** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Volatility (Std Dev)** | 14.04% |
| **Sharpe Ratio** | 0.39 |
| **Max Drawdown** | -41.20% |
| **Win Rate** | 63.2% |
| **Avg Constituents** | 20 stocks |
...
1. Identify all stocks classified in **Pesticides & Agrochemicals**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Pesticides & Agrochemicals Industry Index')
```
