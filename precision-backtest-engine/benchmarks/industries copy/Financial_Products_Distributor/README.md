# Financial Products Distributor Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Financial Products Distributor** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 309.05% |
| **Annualized Return** | 66.90% |
| **Volatility (Std Dev)** | 21.15% |
| **Sharpe Ratio** | 0.73 |
| **Max Drawdown** | -23.10% |
| **Win Rate** | 81.8% |
...
1. Identify all stocks classified in **Financial Products Distributor**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Financial Products Distributor Industry Index')
```
