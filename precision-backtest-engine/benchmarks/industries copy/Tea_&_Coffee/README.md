...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Tea & Coffee** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Volatility (Std Dev)** | 17.86% |
| **Sharpe Ratio** | 0.21 |
| **Max Drawdown** | -67.12% |
| **Win Rate** | 57.9% |
| **Avg Constituents** | 23 stocks |
...
1. Identify all stocks classified in **Tea & Coffee**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Tea & Coffee Industry Index')
```
