# Compressors, Pumps & Diesel Engines Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Compressors, Pumps & Diesel Engines** industry, rebalanced quarterly using point-in-time constituent membership.
...
1. Identify all stocks classified in **Compressors, Pumps & Diesel Engines**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Compressors, Pumps & Diesel Engines Industry Index')
```
