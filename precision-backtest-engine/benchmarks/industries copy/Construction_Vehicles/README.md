# Construction Vehicles Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Construction Vehicles** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 2405.25% |
| **Annualized Return** | 40.36% |
| **Volatility (Std Dev)** | 22.48% |
| **Sharpe Ratio** | 0.50 |
| **Max Drawdown** | -58.10% |
| **Win Rate** | 71.1% |
...
1. Identify all stocks classified in **Construction Vehicles**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Construction Vehicles Industry Index')
```
