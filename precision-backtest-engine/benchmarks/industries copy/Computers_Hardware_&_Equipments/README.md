# Computers Hardware & Equipments Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Computers Hardware & Equipments** industry, rebalanced quarterly using point-in-time constituent membership.
...
1. Identify all stocks classified in **Computers Hardware & Equipments**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Computers Hardware & Equipments Industry Index')
```
