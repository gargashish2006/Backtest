# TV Broadcasting & Software Production Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **TV Broadcasting & Software Production** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Volatility (Std Dev)** | 21.75% |
| **Sharpe Ratio** | 0.19 |
| **Max Drawdown** | -75.60% |
| **Win Rate** | 47.4% |
| **Avg Constituents** | 18 stocks |
...
1. Identify all stocks classified in **TV Broadcasting & Software Production**
...
# Plot
benchmark.plot(x='date', y='index_value', title='TV Broadcasting & Software Production Industry Index')
```
