# Offshore Support Solution Drilling Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Offshore Support Solution Drilling** industry, rebalanced quarterly using point-in-time constituent membership.
...
1. Identify all stocks classified in **Offshore Support Solution Drilling**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Offshore Support Solution Drilling Industry Index')
```
