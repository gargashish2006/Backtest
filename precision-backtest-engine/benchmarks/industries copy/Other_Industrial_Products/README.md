# Other Industrial Products Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Other Industrial Products** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 1377.41% |
| **Annualized Return** | 32.77% |
| **Volatility (Std Dev)** | 18.65% |
| **Sharpe Ratio** | 0.48 |
| **Max Drawdown** | -62.49% |
| **Win Rate** | 71.1% |
...
1. Identify all stocks classified in **Other Industrial Products**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Other Industrial Products Industry Index')
```
