...
def run_gradual_2y_8q_8lookback():
    ...
    # Strategy Config: 30 stocks, 3 max per industry, 8Q LOOKBACK OVERRIDE
    strategy = StructuralAlphaStrategy(dh, num_stocks=30, max_per_industry=3, shareholder_lookback_quarters=8)
    ...
    print(f"Starting Optimized Gradual Entry (30 stocks, 12.5% x 8, 8Q SL) from {start_date.date()}...")
