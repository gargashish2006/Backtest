...
def run_static_v2_backtest_training():
    ...
    print(f"Backtesting Static V2 (Training Period) from {start_date} to {end_date}...")
    ...
    output_path = repo_root / "outputs/static_v2_training_nav.csv"
    nav_df.to_csv(output_path, index=False)
    
    stats = calculate_metrics(nav_df)
    
    print("\n" + "="*60)
    print("STATIC V2 STRATEGY PERFORMANCE (TRAINING PERIOD: 2017-2023)")
    print("="*60)
...
if __name__ == "__main__":
    run_static_v2_backtest_training()
