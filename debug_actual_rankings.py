...
def debug_actual_strategy():
    ...
    # Run a mock calculate_selection but we want to see the rankings
    # I'll just copy the logic here or patch the method to print
    ...
    qualified_industries = ind_stats[ind_stats['mean'] >= 0.50]['industry'].tolist()
    ...
    print(f"--- Top 20 Ranked Industries (RSNP) ---")
    print(ind_ranked.head(20))
    
    print(f"\nPW Industry position:")
    print(ind_ranked[ind_ranked['industry'].str.contains("Aluminium", na=False)])
    
    print(f"\nONGC Industry position:")
    print(ind_ranked[ind_ranked['industry'].str.contains("Oil Exploration", na=False)])

if __name__ == "__main__":
    debug_actual_strategy()
