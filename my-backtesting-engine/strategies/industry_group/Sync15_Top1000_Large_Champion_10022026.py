#!/usr/bin/env python
"""
Champion Model: Sync-15 Top 1000 (Large-Cap)
...
class Sync15_Top1000_Large_Champion_10022026(ContrarianSync15Top1000):
    def __init__(self):
        super().__init__()
        self.LAG_DAYS = 7
...
if __name__ == "__main__":
    Sync15_Top1000_Large_Champion_10022026().run()
