...
class IM_Hybrid_Large(BaseIndustryMomentum):
    def __init__(self):
        super().__init__()
        self.UNIVERSE_SIZE = 1000
        self.MC_SORT_ASCENDING = False # Large-Cap Tilt
        self.NUM_STOCKS = 15
    ...
    def calculate_selection(self, date):
        ...
        # 5. FINAL STOCK SELECTION (Large-Cap Tilt)
        selected = []
...
if __name__ == "__main__":
    print("====================================================================================================")
    print("HYBRID INDUSTRY MOMENTUM - RSNP + 60% SHP FILTER + TOP 1000 + LARGE-CAP TILT")
    print("====================================================================================================")
    IM_Hybrid_Large().run()
