...
class IM_Top1000_Small_RS(BaseIndustryMomentum):
    def __init__(self):
        super().__init__()
        self.UNIVERSE_SIZE = 1000
        self.MC_SORT_ASCENDING = True
    ...
    def calculate_selection(self, date):
        ...
        liquid_isins = universe_isins # Using same simplified liquidity for comparison
