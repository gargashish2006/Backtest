# Consumer Electronics Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Consumer Electronics** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 1706.37% |
| **Annualized Return** | 35.61% |
| **Volatility (Std Dev)** | 19.39% |
| **Sharpe Ratio** | 0.50 |
| **Max Drawdown** | -62.18% |
| **Win Rate** | 65.8% |
...
1. Identify all stocks classified in **Consumer Electronics**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Consumer Electronics Industry Index')
```
