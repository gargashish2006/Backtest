# Integrated Power Utilities Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Integrated Power Utilities** industry, rebalanced quarterly using point-in-time constituent membership.
...
1. Identify all stocks classified in **Integrated Power Utilities**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Integrated Power Utilities Industry Index')
```
