# Other Agricultural Products Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Other Agricultural Products** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 1347.02% |
| **Annualized Return** | 32.48% |
| **Volatility (Std Dev)** | 17.57% |
| **Sharpe Ratio** | 0.49 |
| **Max Drawdown** | -55.21% |
| **Win Rate** | 71.1% |
| **Avg Constituents** | 37 stocks |
...
1. Identify all stocks classified in **Other Agricultural Products**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Other Agricultural Products Industry Index')
```
