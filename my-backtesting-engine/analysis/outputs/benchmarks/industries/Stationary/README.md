...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Stationary** industry, rebalanced quarterly using point-in-time constituent membership.
...
1. Identify all stocks classified in **Stationary**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Stationary Industry Index')
```
