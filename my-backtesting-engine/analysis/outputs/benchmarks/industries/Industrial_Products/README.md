# Industrial Products Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Industrial Products** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 1294.00% |
| **Annualized Return** | 31.96% |
| **Volatility (Std Dev)** | 16.75% |
| **Sharpe Ratio** | 0.51 |
| **Max Drawdown** | -59.28% |
| **Win Rate** | 71.1% |
| **Avg Constituents** | 100 stocks |
...
1. Identify all stocks classified in **Industrial Products**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Industrial Products Industry Index')
```
