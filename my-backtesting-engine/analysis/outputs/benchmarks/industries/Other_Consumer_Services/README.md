# Other Consumer Services Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Other Consumer Services** industry, rebalanced quarterly using point-in-time constituent membership.
...
| Metric | Value |
|--------|-------|
| **Total Periods** | 9 quarters |
| **Date Range** | 2023-09-30 to 2025-09-30 |
| **Total Return** | -4.81% |
| **Annualized Return** | -2.17% |
| **Volatility (Std Dev)** | 17.71% |
| **Sharpe Ratio** | 0.06 |
| **Max Drawdown** | -36.56% |
| **Win Rate** | 44.4% |
...
1. Identify all stocks classified in **Other Consumer Services**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Other Consumer Services Industry Index')
```
