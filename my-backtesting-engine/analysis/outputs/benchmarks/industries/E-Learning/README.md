...
This benchmark represents the **equal-weighted return** of all stocks classified in the **E-Learning** industry, rebalanced quarterly using point-in-time constituent membership.
...
1. Identify all stocks classified in **E-Learning**
...
# Plot
benchmark.plot(x='date', y='index_value', title='E-Learning Industry Index')
```
