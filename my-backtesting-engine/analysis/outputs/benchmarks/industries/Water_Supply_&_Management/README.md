# Water Supply & Management Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Water Supply & Management** industry, rebalanced quarterly using point-in-time constituent membership.
...
| Metric | Value |
|--------|-------|
| **Total Periods** | 14 quarters |
| **Date Range** | 2022-06-30 to 2025-09-30 |
| **Total Return** | 415.33% |
| **Annualized Return** | 59.75% |
| **Volatility (Std Dev)** | 66.78% |
| **Sharpe Ratio** | 0.33 |
| **Max Drawdown** | -32.64% |
| **Win Rate** | 71.4% |
...
1. Identify all stocks classified in **Water Supply & Management**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Water Supply & Management Industry Index')
```
