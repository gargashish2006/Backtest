# Telecom - Services Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Telecom - Services** industry group, rebalanced quarterly using point-in-time constituent membership.
...
| **Volatility (Std Dev)** | 28.41% |
| **Sharpe Ratio** | 0.24 |
| **Max Drawdown** | -78.05% |
| **Win Rate** | 50.0% |
| **Avg Constituents** | 17 stocks |
...
- **17 stocks** (on average)
- Range: 14 to 22 stocks per quarter
...
1. Identify all stocks classified in **Telecom - Services** industry group
...
plt.title('Telecom - Services Industry Group Index')
