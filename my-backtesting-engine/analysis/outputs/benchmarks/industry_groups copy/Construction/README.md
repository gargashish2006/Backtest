# Construction Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Construction** industry group, rebalanced quarterly using point-in-time constituent membership.
...
| **Volatility (Std Dev)** | 19.01% |
| **Sharpe Ratio** | 0.30 |
| **Max Drawdown** | -74.50% |
| **Win Rate** | 57.9% |
| **Avg Constituents** | 79 stocks |
...
- **79 stocks** (on average)
- Range: 53 to 116 stocks per quarter
...
1. Identify all stocks classified in **Construction** industry group
...
plt.title('Construction Industry Group Index')
