# Media Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Media** industry group, rebalanced quarterly using point-in-time constituent membership.
...
| **Volatility (Std Dev)** | 20.59% |
| **Sharpe Ratio** | 0.20 |
| **Max Drawdown** | -74.02% |
| **Win Rate** | 52.6% |
| **Avg Constituents** | 16 stocks |
...
- **16 stocks** (on average)
- Range: 10 to 24 stocks per quarter
...
1. Identify all stocks classified in **Media** industry group
...
plt.title('Media Industry Group Index')
