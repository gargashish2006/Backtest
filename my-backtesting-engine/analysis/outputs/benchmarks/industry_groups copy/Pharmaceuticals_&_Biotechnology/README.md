# Pharmaceuticals & Biotechnology Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Pharmaceuticals & Biotechnology** industry group, rebalanced quarterly using point-in-time constituent membership.
...
| **Volatility (Std Dev)** | 14.93% |
| **Sharpe Ratio** | 0.47 |
| **Max Drawdown** | -32.77% |
| **Win Rate** | 60.5% |
| **Avg Constituents** | 148 stocks |
...
- **148 stocks** (on average)
- Range: 116 to 189 stocks per quarter
...
1. Identify all stocks classified in **Pharmaceuticals & Biotechnology** industry group
...
plt.title('Pharmaceuticals & Biotechnology Industry Group Index')
