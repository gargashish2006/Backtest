# Beverages Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Beverages** industry group, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 2188.15% |
| **Annualized Return** | 39.03% |
| **Volatility (Std Dev)** | 20.00% |
| **Sharpe Ratio** | 0.51 |
| **Max Drawdown** | -48.79% |
| **Win Rate** | 63.2% |
...
- Range: 16 to 31 stocks per quarter
...
1. Identify all stocks classified in **Beverages** industry group
...
plt.title('Beverages Industry Group Index')
