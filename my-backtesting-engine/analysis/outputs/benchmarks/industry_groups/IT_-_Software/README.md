# IT - Software Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **IT - Software** industry group, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 2203.18% |
| **Annualized Return** | 39.12% |
| **Volatility (Std Dev)** | 18.95% |
| **Sharpe Ratio** | 0.54 |
| **Max Drawdown** | -41.41% |
| **Win Rate** | 65.8% |
| **Avg Constituents** | 87 stocks |
...
- **87 stocks** (on average)
- Range: 61 to 125 stocks per quarter
...
1. Identify all stocks classified in **IT - Software** industry group
...
plt.title('IT - Software Industry Group Index')
