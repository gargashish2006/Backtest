# Chemicals & Petrochemicals Industry Group Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Chemicals & Petrochemicals** industry group, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 844.03% |
| **Annualized Return** | 26.66% |
| **Volatility (Std Dev)** | 15.15% |
| **Sharpe Ratio** | 0.47 |
| **Max Drawdown** | -49.37% |
| **Win Rate** | 63.2% |
| **Avg Constituents** | 169 stocks |
| **Avg Industries** | 9 industries |
...
- **9 distinct industries** (on average)
- **169 stocks** (on average)
- Range: 135 to 223 stocks per quarter
...
1. Identify all stocks classified in **Chemicals & Petrochemicals** industry group
...
plt.title('Chemicals & Petrochemicals Industry Group Index')
