# Auto Dealer Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Auto Dealer** industry, rebalanced quarterly using point-in-time constituent membership.
...
| Metric | Value |
|--------|-------|
| **Total Periods** | 7 quarters |
| **Date Range** | 2024-03-31 to 2025-09-30 |
| **Total Return** | -38.20% |
| **Annualized Return** | -24.05% |
| **Volatility (Std Dev)** | 14.99% |
| **Sharpe Ratio** | -0.36 |
| **Max Drawdown** | -39.62% |
| **Win Rate** | 42.9% |
...
1. Identify all stocks classified in **Auto Dealer**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Auto Dealer Industry Index')
```
