...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Packaging** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 814.47% |
| **Annualized Return** | 26.23% |
| **Volatility (Std Dev)** | 17.31% |
| **Sharpe Ratio** | 0.42 |
| **Max Drawdown** | -63.19% |
| **Win Rate** | 68.4% |
| **Avg Constituents** | 54 stocks |
...
1. Identify all stocks classified in **Packaging**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Packaging Industry Index')
```
