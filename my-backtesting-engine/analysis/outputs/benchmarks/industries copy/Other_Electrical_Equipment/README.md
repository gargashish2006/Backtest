# Other Electrical Equipment Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Other Electrical Equipment** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 3289.24% |
| **Annualized Return** | 44.90% |
| **Volatility (Std Dev)** | 20.78% |
| **Sharpe Ratio** | 0.56 |
| **Max Drawdown** | -60.31% |
| **Win Rate** | 71.1% |
...
1. Identify all stocks classified in **Other Electrical Equipment**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Other Electrical Equipment Industry Index')
```
