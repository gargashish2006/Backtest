# Gems, Jewellery And Watches Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Gems, Jewellery And Watches** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 1510.73% |
| **Annualized Return** | 33.98% |
| **Volatility (Std Dev)** | 16.31% |
| **Sharpe Ratio** | 0.54 |
| **Max Drawdown** | -43.04% |
| **Win Rate** | 73.7% |
...
1. Identify all stocks classified in **Gems, Jewellery And Watches**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Gems, Jewellery And Watches Industry Index')
```
