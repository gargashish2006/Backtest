# Commodity Chemicals Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Commodity Chemicals** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 1215.18% |
| **Annualized Return** | 31.16% |
| **Volatility (Std Dev)** | 16.49% |
| **Sharpe Ratio** | 0.50 |
| **Max Drawdown** | -56.12% |
| **Win Rate** | 63.2% |
...
1. Identify all stocks classified in **Commodity Chemicals**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Commodity Chemicals Industry Index')
```
