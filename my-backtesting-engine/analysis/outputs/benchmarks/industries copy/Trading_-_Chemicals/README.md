# Trading - Chemicals Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Trading - Chemicals** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 897.91% |
| **Annualized Return** | 27.40% |
| **Volatility (Std Dev)** | 14.31% |
| **Sharpe Ratio** | 0.50 |
| **Max Drawdown** | -19.66% |
| **Win Rate** | 63.2% |
...
1. Identify all stocks classified in **Trading - Chemicals**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Trading - Chemicals Industry Index')
```
