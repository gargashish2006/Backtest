# Power Generation Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Power Generation** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Total Return** | 1077.70% |
| **Annualized Return** | 29.64% |
| **Volatility (Std Dev)** | 26.55% |
| **Sharpe Ratio** | 0.36 |
| **Max Drawdown** | -68.60% |
| **Win Rate** | 55.3% |
| **Avg Constituents** | 25 stocks |
...
1. Identify all stocks classified in **Power Generation**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Power Generation Industry Index')
```
