# Business Process Outsourcing (BPO)/ Knowledge Process Outsourcing (KPO) Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Business Process Outsourcing (BPO)/ Knowledge Process Outsourcing (KPO)** industry, rebalanced quarterly using point-in-time constituent membership.
...
| **Volatility (Std Dev)** | 19.78% |
| **Sharpe Ratio** | 0.36 |
| **Max Drawdown** | -59.24% |
| **Win Rate** | 63.2% |
| **Avg Constituents** | 8 stocks |
...
1. Identify all stocks classified in **Business Process Outsourcing (BPO)/ Knowledge Process Outsourcing (KPO)**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Business Process Outsourcing (BPO)/ Knowledge Process Outsourcing (KPO) Industry Index')
```
