# Animal Feed Industry Benchmark
...
This benchmark represents the **equal-weighted return** of all stocks classified in the **Animal Feed** industry, rebalanced quarterly using point-in-time constituent membership.
...
1. Identify all stocks classified in **Animal Feed**
...
# Plot
benchmark.plot(x='date', y='index_value', title='Animal Feed Industry Index')
```
