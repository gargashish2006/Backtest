...
from strategies.contrarian_unlimited import ContrarianUnlimitedStrategy
...
def run_unlimited_backtest():
    ...
    # 2. Setup Strategy
    strategy = ContrarianUnlimitedStrategy(dh)
    ...
    # 4. Run Backtest
    print("Starting Unlimited Portfolio Backtest (All qualifying isins, No limits)...")
    ...
    print("\n" + "="*50)
    print("UNLIMITED PORTFOLIO PERFORMANCE (NO LIMITS)")
    print("="*50)
    ...
    print("="*50)
    print(f"{'Metric':<20} | {'Unlimited':<15} | {'Champ (15/3)':<15}")
    print("-" * 55)
