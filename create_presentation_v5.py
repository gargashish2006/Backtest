...
def create_full_chart_slide(prs, title, subtitle, image_path, bullets=[], page=0, highlight_text=None):
    ...
    # Highlight box (for outperformance stats)
    if highlight_text:
        ...
        p.font.size = Pt(18)
        p.font.bold = True
        p.font.color.rgb = highlight_color # Orange
...
# Save
output_path = '/Users/shubhrakasana/Desktop/oleander/olgo_mobile/repos/Backtest/precision-backtest-engine/Champion_Strategy_Presentation_v5.pptx'
prs.save(output_path)
print(f"Presentation v5 saved to: {output_path}")
